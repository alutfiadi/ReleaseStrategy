sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("AL.ReleaseStrategy.controller.EditGroup", {
		...
		onInit: function () {
			...
			// this.oRouter.getTarget("EditGroup").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("EditGroup").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
			this.getView().bindElement({
				path: decodeURIComponent("/" + oEvent.getParameter("arguments").rgPath),
		...
		_onButtonPress: function (oEvent) {
			...
			this.oModel.update("/ReleaseGroupSet('" + irgcode + "')", oObject, {
				success: function (oData, oResponse) {
					// Success
					oDialog.close();
					MessageToast.show("Release Group " + irgcode + " change successfully");
					this.refresh();
					this.navBack();
